...
const startGameBtn = document.getElementById('startGameBtn'); // Now for "Start New Round"
...
async function fetchWordsAndHints() {
    try {
        ...
        // The hint button (if still present in HTML) won't have a JS listener
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    skipBtn.disabled = true;
    fetchWordsAndHints(); // Fetch words and hints when the DOM is loaded
>>>>>>> 3ed24055b75f4061c7cda16fbbbf72d24e0a99fe
});